...
namespace ProjectA_DB {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public DataTable1Row AddDataTable1Row(int ProjectId, string Title, int AdvisorId, string FirstName, string LastName, string Value, int StudentId, string RegistrationNo) {
        ...
        public partial class DataTable2DataTable : global::System.Data.TypedTableBase<DataTable2Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public DataTable2Row AddDataTable2Row(int EvaluationId, string Name, int TotalMarks, int ObtainedMarks, int ProjectId, string Title, int StudentId, string RegistrationNo) {
        ...
        public partial class DataTable2Row : global::System.Data.DataRow {
            ...
            public int EvaluationId {
                get {
                    return ((int)(this[this.tableDataTable2.EvaluationIdColumn]));
                }
                set {
                    this[this.tableDataTable2.EvaluationIdColumn] = value;
                }
            }
            ...
            public int TotalMarks {
                get {
                    return ((int)(this[this.tableDataTable2.TotalMarksColumn]));
                }
                set {
                    this[this.tableDataTable2.TotalMarksColumn] = value;
                }
            }
            ...
            public int ObtainedMarks {
                get {
                    return ((int)(this[this.tableDataTable2.ObtainedMarksColumn]));
                }
                set {
                    this[this.tableDataTable2.ObtainedMarksColumn] = value;
                }
            }
            ...
            public int ProjectId {
                get {
                    return ((int)(this[this.tableDataTable2.ProjectIdColumn]));
                }
                set {
                    this[this.tableDataTable2.ProjectIdColumn] = value;
                }
            }
...
namespace ProjectA_DB.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjectA_DB.Properties.Settings.Default.ProjectAConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        GroupProject.ProjectId, Project.Title, ProjectAdvisor.AdvisorId, Person.FirstName, Person.LastName, Lookup.Value, GroupStudent.StudentId, Student.RegistrationNo
FROM            [Group] INNER JOIN
                         ...
                         Student ON Student.Id = GroupStudent.StudentId";
    ...
    public partial class DataTable2TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        GroupEvaluation.EvaluationId, Evaluation.Name, Evaluation.TotalMarks, GroupEvaluation.ObtainedMarks, GroupProject.ProjectId, Project.Title, GroupStudent.StudentId, Student.RegistrationNo
FROM            [Group] INNER JOIN
